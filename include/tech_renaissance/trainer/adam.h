 ...
 *
 * 6. 如果启用权重衰减：param = param * (1 - lr * weight_decay)
 */
...
private:
    ...
    /**
     * @brief 应用权重衰减
     * @details param = param * (1 - lr * weight_decay)
     * @param param 参数张量引用
     */
     ...
     * @param param_index 参数索引
     */
    void apply_adam_update(Tensor& param, const Tensor& m_hat, const Tensor& v_hat, size_t param_index);
