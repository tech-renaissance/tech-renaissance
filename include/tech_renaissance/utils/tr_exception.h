 ...
 * @brief 形状错误异常
 */
class ShapeError : public TRException {
public:
    using TRException::TRException;
    const char* type() const noexcept override { return "ShapeError"; }
};
...
#define TR_THROW_SHAPE_ERROR(msg)     TR_THROW_TYPE(ShapeError, msg)